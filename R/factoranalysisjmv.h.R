...
factorAnalysisjmvOptions <- if (requireNamespace('jmvcore')) R6::R6Class(
...
factorAnalysisjmvResults <- if (requireNamespace('jmvcore')) R6::R6Class(
...
factorAnalysisjmvBase <- if (requireNamespace('jmvcore')) R6::R6Class(
